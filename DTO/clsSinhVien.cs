...
namespace DTO
{
    public class clsSinhVien
    {
	  ...
	  private int _KHOAHOC;
        ...
        public clsSinhVien(string mASV, string hO, string tEN, string gIOITINH, string dANTOC, string dIACHI, string qUEQUAN, string sODIENTHOAI, string eMAIL, int kHOAHOC)
        {
            _MASV = mASV;
            _HO = hO;
            _TEN = tEN;
